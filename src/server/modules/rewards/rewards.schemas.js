...
export const AI_REWARD_KEYS = Object.freeze([
  'nao_repetir',
  'aprender_preferencias'
]);

export const DOPAMENU_CATEGORIES = Object.freeze([
  'entrada',
  'principal',
  'sobremesa'
]);
...
export const rewardFeedbackSchema = z.object({
  event_id: positiveId,
...
export const createDopamenuItemSchema = z.object({
...
export const updateDopamenuItemSchema = z.object({
  category: z.enum(DOPAMENU_CATEGORIES, {
    error: 'A categoria deve ser entrada, principal ou sobremesa.'
  }),
  label: trimmedLabel
...
export const aiRewardConfigSchema = z.object({
